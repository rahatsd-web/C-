...
// Write a function that prints Hi is user is England & bonjur ifthe user is french
#include <stdio.h>
void hi();
void bonjur();
...
//WAF to calculate percentage of a student from marks in 2 subject
#include <stdio.h>
...
////WAF to print n terms of the finoncci sequence
#include <stdio.h>
